...
const ProductDescriptionInfo = ({
  ...
  const handleDecreaseQuantity = async (product) => {
    ...
    try {
      ...
      cogoToast.success("Product quantity decreased", {
        position: "bottom-left",
      });
    } catch (error) {
      console.error("Error decreasing quantity in cart and database:", error);
      cogoToast.error("Failed to decrease quantity", {
        position: "bottom-left",
      });
    }
  };
