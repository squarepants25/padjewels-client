...
const IconGroup = ({ iconWhiteClass, sidebarMenu, menuWhiteClass }) => {
  ...
  const [token, setToken] = useState(
    localStorage.getItem("my-access-token-of-padjewels")
  );
  ...
  return (
    <>
      <div
        className={clsx("header-right-wrap  ", iconWhiteClass, {
      ...
      >
        <div className="same-style account-setting  d-lg-block  ">
          ...
          >
            <i className="pe-7s-user-female" style={{ fontSize: "2rem" }} />
          </button>
            ...
            <ul>
              {!token ? (
                <>
                  ...
                  <li>
                    <Link
                      to={process.env.PUBLIC_URL + "/login-register/register"}
                    >
                      Register
                    </Link>
                  </li>
        ...
        <div className="same-style header-wishlist">
          <Link to={process.env.PUBLIC_URL + "/wishlist"}>
            <i className="pe-7s-like" style={{ fontSize: "2rem" }} />
        ...
        <div className="same-style cart-wrap d-none d-lg-block">
          <button className="icon-cart" onClick={(e) => handleClick(e)}>
            <i className="pe-7s-shopbag" style={{ fontSize: "2rem" }} />
            <span className="count-style">
